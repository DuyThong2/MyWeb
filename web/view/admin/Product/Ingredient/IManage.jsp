                ...
                <div id="table" class="col-md-10">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-2 d-flex justify-content-end">
                            <button class="btn btn-secondary w-75" onclick="location.href = '<%=insertUrl%>'">Insert</button>
                                ...
                                <c:forEach items="${table}" var="item">
                                    <tr>    
                                        ...
                                        <td >
                                            ...
                                            <a href="<%=updateUrl%>&id=${item.getId()}" class="btn btn-md btn-success w-100">Edit</a>
                                        </td>
                                    </tr>
                    ...
                    <div class="mt-4 fixed-search-bar w-100 d-flex justify-content-center">
