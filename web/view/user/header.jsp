...
<%
    ...
    String PlanURL = request.getContextPath() + "/MainController?action=plan";
    String myPlan = request.getContextPath() + "/MainController?action=customerPlanPage";
    String logoutURL = request.getContextPath() + "/MainController?action=logout";
        ...
        <div class="navbar navbar-light bg-white  navbar-container text-center">
            ...
            <div class="search-user-cart col-lg-4  col-md-5 col-sm-5 ">
                ...
                <a href="<%= logoutURL%>">
                    <svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960"
                         width="40px" fill="#000000">
                    <path d="M400-160v-64h400v-512H400v-64h400q27 0 46.5 19.5T866.5-832v576q0 27-19.5 46.5T800-160H400Zm-81.1-160-44.6-44.6 145.1-145.4H0v-64h419.4L274.3-715l44.6-44.6 235.4 235.4-235.4 235.2Z"/>
                    </svg>
                </a>
                    </c:if>
            </div>
