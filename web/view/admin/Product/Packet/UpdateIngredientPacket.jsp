...
<!DOCTYPE html>
<%
    String redirectURL = request.getContextPath() + "/AMainController?action=PacketUpdate";
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-8">
                    <h4>Search Ingredient ${packetId}</h4>
                    <!-- Form for searching ingredients -->
                    <form class="form-inline mb-3" action="<%=redirectURL%>&packetId=${packetId}" method="POST">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <c:forEach items="${ingredientList}" var="foundItem">
                                <tr>
                                    <form action="<%=redirectURL%>&packetId=${packetId}" method="POST">
                ...
                <div class="col-md-4">
                        ...
                        <tbody id="insertedIngredients">
                            ...
                            <c:forEach items="<%=insertedIngredient%>" var="entry">
                                <tr>
                                    ...
                                    <td>${entry.value}</td>
                                    <td>
                                         <a href="<%=redirectURL%>&removeId=${entry.key.getId()}&packetId=${packetId}" class="btn btn-danger">Remove</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
                    ...
                    <!-- Finalize Button -->
                    <a href="<%=redirectURL%>&finalize=true&packetId=${packetId}" class="btn btn-primary mt-3" name="finalize">Finalize</a>
                </div>
            </div>
        </div>
