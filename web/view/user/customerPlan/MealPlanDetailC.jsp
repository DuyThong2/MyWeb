...
<html>
    ...
    <body>
        <%
            String addCustomerPlanUrl = request.getContextPath() + "/MainController?action=customerPlan";
            ...
            String addAllToCartUrl = request.getContextPath() +"/MainController?action=";
                        ...
                        <div class="col-lg-12 col-xl-12">
                            <div class="row g-4">
                                ...
                                <div class="col-xl-6 col-lg-5">
                                    ...
                                    <form id="orderForm" action="<%= addCustomerPlanUrl %>&mealPlanId=<%= mealPlan.getId() %>" method="POST">
                                        <div class="row w-50 p-3 d-flex flex-column">
                                            ...
                                            <a href="<%= addAllToCartUrl %>" class="detail-button btn btn-lg">ADD TO CART</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
