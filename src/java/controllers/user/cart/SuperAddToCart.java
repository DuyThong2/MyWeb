 ...
 * @author ASUS
 */
@WebServlet(name = "SuperAddToCart", urlPatterns = {"/user/cart/SuperAddToCart"})
public class SuperAddToCart extends HttpServlet {
     ...
     */
    private final String shopURL = "MainController?action=cartDisplayPage";
