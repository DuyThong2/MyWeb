 ...
 * @author Admin
 */
@WebServlet(name = "OrderDetail", urlPatterns = {"/admin/order/OrderDetail"})
public class OrderDetailController extends HttpServlet {
     ...
     */
    private final String REDIRECT_PAGE = "/AMainController?action=orderManagePage";
    private final String DETAIL_PAGE = "/AMainController?action=orderDetailPage";
